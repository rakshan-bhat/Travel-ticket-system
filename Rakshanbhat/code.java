    ...
    static String date_and_time;
      public static void display()
      {
          ...
          System.out.println("enter your name and aadhar");
           ...
           try{aadhar=sc.nextLong();}
           catch(Exception e1){System.out.println("Please enter a valid aadhar card number");display();}
        ...
        {System.out.println("Please choose 1,2,3 or 4"); display();}      
        }
...
public static void Rakshan()
{
        ...
        switch(choice1)
        {
         ...
         if(search1>5)
         {System.out.println("PLese choose 1,2,3,4 or 5");Rakshan();}
         ...
         {System.out.println("Please choose 1,2,3,4 or 5");Rakshan();}
         ...
         {System.out.println("Please choose 1 or 2");Rakshan();}
         System.out.println("Please wait while we generate your bill!");
